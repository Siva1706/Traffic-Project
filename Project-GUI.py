...
class Window(Frame):
    ...
    def open_file(self):
        ...
        ret, image = cap.read()
        cv2.imwrite('D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Images/preview.jpg', image)

        self.show_image('D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Images/preview.jpg')
    ...
    def regionOfInterest(self):
        ...
        img = cv2.imread('D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Images/preview.jpg')
        cv2.line(img,(0,200),(1600,200),(255,0,0),2)
        self.line.append((0, 200))
        self.line.append((1600, 200))
        cv2.imwrite('D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Images/copy.jpg', img)
        self.show_image('D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Images/copy.jpg')
        self.main_process()
        print("Executed Successfully!!!")
        print(License_dict)
        with open('report.txt', 'a+') as f:
            for i in License_dict:
                if License_dict[i]>1:
                    f.write(i)
                    f.write("\n")
        f.close()
    ...
    def main_process(self):
        ...
        fps = reader.get_meta_data()['fps']    
        writer = imageio.get_writer('D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Resources/output/output.mp4', fps = fps)
        ...
        while True:
            ...
            if cv2.waitKey(10) & 0xFF == ord('q'):
                writer.close()
                #exec(open('License_Plate_Recognition.py').read())
                break
