    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite("D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/Detected Images/violation_"+str(dcnt)+".jpg", cimg)
                image_number="Detected Images/violation_"+str(dcnt)+".jpg"
                newlicense=getLicensePlateNumber(image_number)
                if newlicense==0:
                    print('License Plate Not Detected')
                else:
                    print('License_Plate')
                    print(newlicense)
                    if newlicense not in License_dict:
                        License_dict[newlicense]=1
                    else:
                        License_dict[newlicense]+=1
                dcnt = dcnt+1
            else:
...
weights_path = "D:/FINAL YEAR PROJECT/Traffic_Violation1/Traffic-Signal-Violation-Detection-System/yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
